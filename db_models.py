...
class HiddenAlertRule(Base):
    ...
    rule_id: Mapped[str] = mapped_column(
        String, ForeignKey("alert_rules.id", ondelete="CASCADE"), nullable=False, index=True
    )
    created_at: Mapped[datetime] = mapped_column(DateTime, default=_now, nullable=False)
...
class HiddenNotificationChannel(Base):
    ...
    channel_id: Mapped[str] = mapped_column(
        String, ForeignKey("notification_channels.id", ondelete="CASCADE"), nullable=False, index=True
    )
    created_at: Mapped[datetime] = mapped_column(DateTime, default=_now, nullable=False)
