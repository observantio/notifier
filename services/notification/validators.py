"""
Validation utilities for notification channel configurations, providing functions to validate the configuration of
different notification channels such as email, Slack, Microsoft Teams, generic webhooks, and PagerDuty. This module
checks for the presence of required fields based on the channel type, validates URLs for webhook-based channels, and
ensures that email configurations have the necessary information for sending emails. The validation functions return a
